...
```bash
bitasmbl pull --repoUrl https://github.com/he1snber8/Bitasmbl_Bitasmbl-my-badass-frontend-398_b88_347 --appId 347 --repoId 175
```

## 3) Enter into the main directory and start coding!

```bash
cd Bitasmbl_Bitasmbl-my-badass-frontend-398_b88_347
```
